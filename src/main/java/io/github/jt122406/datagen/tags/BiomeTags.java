...
public class BiomeTags extends FabricTagProvider<Biome>  {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        ...
        getOrCreateTagBuilder(ConventionalBiomeTags.AQUATIC)
                .addOptionalTag(Tags.Biomes.IS_WATER);
        ...
        getOrCreateTagBuilder(Tags.Biomes.IS_WATER).forceAddTag(net.minecraft.tags.BiomeTags.IS_OCEAN).forceAddTag(net.minecraft.tags.BiomeTags.IS_RIVER);
